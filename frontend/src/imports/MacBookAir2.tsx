import svgPaths from "./svg-cxzoh2cc71";
...
function Frame11() {
  return (
    <div className="box-border content-stretch flex gap-[5px] items-center justify-end px-[10px] py-0 relative shrink-0 w-[140px]">
      <div className="font-['Instrument_Sans:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#83667e] text-[18px] text-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Frame7() {
  return (
    <div className="bg-white h-[447px] relative rounded-[40px] shrink-0 w-[342px]">
