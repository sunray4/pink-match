...
function CompareDialog( {originalProduct, newProduct} : CompareModalProps) {
  return (
    <Dialog.Portal>
        ...
        <Dialog.Content 
            className='flex flex-col border-1 border-[#b398ae] border-solid bg-white fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[90vw] h-[90vh] rounded-2xl shadow-lg focus:outline-none overflow-visible'>
            <VisuallyHidden.Root>
            ...
            <div className="overflow-auto p-14 flex justify-evenly items-start gap-6 w-full">
